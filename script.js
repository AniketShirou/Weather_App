...
const API_KEY = "54825490cac3d84ee4df304d47c75bd6";
...
function renderWeatherInfo(weatherInfo) 
{
  ...
  const temp2 = document.querySelector("[data-temp-inF]");
  ...
  temp2.innerText = `${((weatherInfo?.main?.temp.toFixed(2)*9/5)+32).toFixed(3)} °F`;
